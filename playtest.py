...
class DeckManager:
    """Class managing the deck of cards in a game.

    Attributes:
        deck: The current selected deck.
    """
    def __init__(self):
        """Initializes a DeckManager instance."""
        self.deck = None
    ...
    def set_deck(self, deck):
        """Sets the current deck to the provided deck.

        Args:
            deck (Deck): The deck to be set.
        """
        self.deck = deck
